...
export default function RootLayout({
  ...
  id: "1780134876344",
  name: "CyberWolf",
  businessName: "Tehcnical Corp",
  model: "big-pickle",
  primaryColor: "#2563EB",
  logo: "",
  welcomeMessage: "Welcome to Technical Corp, How can i help you today?",
  poweredBy: "Technical Corp",
  apiUrl: "https://bot-forge-builder.vercel.app/api/chat"
};`}
</Script>
