...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            ...
            if (productData) {
                ...
                setExistingThumbUrl(productData.thumb_url);
                setThumbPreview(productData.thumb_url);
                setExistingFilePath(productData.file_path);
            }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Upload New Product File if provided
            if (productFile) {
            ...
            <div className="max-w-5xl mx-auto">
                <div className="flex justify-between items-center mb-12">
                    <div>
                        ...
                        <h1 className="text-4xl font-black text-white uppercase italic">Edit Digital Product</h1>
                    </div>
                    <button
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-brand-primary/50 transition-all appearance-none font-medium"
                                        >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-brand-primary/50 transition-all resize-none font-medium"
                                ...
                                {formData.features.map((feature, index) => (
                                    <div key={index} className="flex gap-4">
                                        <input
                                            ...
                                            className="flex-grow bg-white/5 border border-white/10 rounded-xl px-6 py-3 text-white focus:outline-none focus:border-brand-primary/50 transition-all text-sm font-medium"
                                        />
                                    ...
                                    {productFile ? (
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-grow min-w-0">
                                                ...
                                                <div className="text-[10px] text-white/40">New file selected</div>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-grow min-w-0">
                                                <div className="text-xs font-bold text-white truncate">Existing File Attached</div>
                                                <div className="text-[10px] text-white/40">Upload new to replace</div>
                                            </div>
                                            <label className="cursor-pointer">
                                                <Upload size={16} className="text-white/20 hover:text-brand-primary transition-all" />
                                                <input type="file" onChange={(e) => e.target.files && setProductFile(e.target.files[0])} className="hidden" />
                                            </label>
                                        </div>
                                    ) : (
